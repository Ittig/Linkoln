...
class Util {
	...
	static String getOrdinale(String text) {
		...
		if(text.indexOf("sesto") > -1) return "6";
		if(text.indexOf("settimo") > -1) return "7";
		if(text.indexOf("ottavo") > -1) return "8";
		if(text.indexOf("nono") > -1) return "9";
		if(text.indexOf("decimo") > -1) return "10";
		if(text.indexOf("undicesimo") > -1) return "11";
		if(text.indexOf("dodicesimo") > -1) return "12";
		if(text.indexOf("tredicesimo") > -1) return "13";
		if(text.indexOf("quattordicesimo") > -1) return "14";
		if(text.indexOf("quindicesimo") > -1) return "15";
		if(text.indexOf("sedicesimo") > -1) return "16";
		if(text.indexOf("diciassettesimo") > -1) return "17";
		if(text.indexOf("diciottesimo") > -1) return "18";
		if(text.indexOf("diciannovesimo") > -1) return "19";
		if(text.indexOf("ventesimo") > -1) return "20";
		if(text.indexOf("ventunesimo") > -1) return "21";
		if(text.indexOf("ventiduesimo") > -1) return "22";
		if(text.indexOf("ventitreesimo") > -1) return "23";
		if(text.indexOf("ventiquattresimo") > -1) return "24";
		if(text.indexOf("venticinquesimo") > -1) return "25";
